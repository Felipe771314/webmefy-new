import registerBlocks from '../blocks/register-blocks.schema';
...
module.exports = {
  ...
  settings: [
    {
      type: 'select',
      label: 'Social Login position',
      id: 'social_login_position',
      options: [
        {
          value: 'above_login_form',
          label: 'Above login form',
        },
        {
          value: 'below_login_form',
          label: 'Below login form',
        },
      ],
      default: 'above_login_form',
    },
    {
      type: 'header',
      content: 'Login',
    ...
    {
      type: 'select',
      label: 'Login form position',
      id: 'login_form_position',
      info: "Desktop only: If 'Register form' is active",
      options: [
        {
          value: 'left',
          label: 'Left',
    ...
    {
      type: 'checkbox',
      id: 'mobile_tabs_toggle',
      label: 'Show tabs on Mobile',
      info: 'Add navigation tab for login and register ',
      default: true,
    },
    {
      type: 'text',
    ...
    {
      type: 'select',
      id: 'login_title_text_transform',
      label: 'Login title text transform',
      options: [
        {
          value: '',
          label: 'Default',
    ...
    {
      type: 'text',
      id: 'connexion_subtitle',
      label: 'Login subtitle',
      default: 'Please enter your email and password:',
    },
    {
      type: 'checkbox',
      label: 'Force CAPTCHA',
      id: 'force_login_form_captcha',
      default: true,
