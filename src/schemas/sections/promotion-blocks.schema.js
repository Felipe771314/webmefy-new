...
const featuredProducts = require('../blocks/promotion-block-featured-products-settings.schema');
const afp_settings = require('../common/afp.schema');
const toggleVisibility = require('../common/toggle-visiblity.schema');
